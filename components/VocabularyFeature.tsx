...
export default function VocabularyFeature() {
  const [activeSubTab, setActiveSubTab] = useState<'topic' | 'word'>('topic')
  ...
  return (
    <div className={styles.container}>
      <div className={styles.subTabs}>
        <button 
          className={`${styles.subTab} ${activeSubTab === 'topic' ? styles.subTabActive : ''}`}
          onClick={() => setActiveSubTab('topic')}
        >
          Topic based
        </button>
        <button 
          className={`${styles.subTab} ${activeSubTab === 'word' ? styles.subTabActive : ''}`}
